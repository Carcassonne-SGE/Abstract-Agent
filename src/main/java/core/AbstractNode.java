...
public abstract class AbstractNode<A extends AbstractMctsAgent<N>, N extends AbstractNode<A, N>> {
    ...
    ///
    /// applys the action/card pop of the current node
    ...
    /// getSelectionScore
    ///
    /// calculates the ucb using the transform of the agent can be used bei the nodes
    ...
    ///
    /// takes a children array iterates over it to find a child with zero visits. Returns sich a child
